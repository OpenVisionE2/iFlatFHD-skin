...
weather_city = config.plugins.iFlatFHD.city.value
degreetype = config.plugins.iFlatFHD.degreetype.value
windtype = config.plugins.iFlatFHD.windtype.value
weather_location =  config.plugins.iFlatFHD.weather_location.value
...
class iflatMSNWeather(Poll, Converter, object):
